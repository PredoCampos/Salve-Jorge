...
namespace TarodevController {
    ...
    /// distancia = tempo (Time.deltaTime) * velocidade (_currentAcelleration)
    ...
    public class PlayerController : MonoBehaviour, IPlayerController {
        ...
        private void CalculateWalk() {
            ...
            if (Input.X != 0) {
                ...
                _currentHorizontalSpeed += (Input.X * _currentAcceleration * Time.deltaTime);
                ...
                _currentHorizontalSpeed = Mathf.MoveTowards(_currentHorizontalSpeed, _constantAcceleration, _deAcceleration * Time.deltaTime);
            }
