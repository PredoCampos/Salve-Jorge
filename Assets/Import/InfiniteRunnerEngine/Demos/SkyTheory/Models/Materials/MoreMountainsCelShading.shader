Shader "MoreMountains/CelShading" {
	Properties {
	...
	SubShader{
		...
		CGPROGRAM
			#pragma surface surf CS alphatest:_Cutoff
			#pragma target 3.0
			...
			inline fixed4 LightingCS (SurfaceOutput s, fixed3 lightDir, fixed3 viewDir, fixed atten)
			{
